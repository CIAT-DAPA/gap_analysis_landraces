...
base_2<-base[is.na(base$Y),]; base_2<-base_2[complete.cases(base_2[,-1]),] #Only if you want to predict NAs races, because it has NAs for races. It is in external_df parameter into the function (external_df=base_2)

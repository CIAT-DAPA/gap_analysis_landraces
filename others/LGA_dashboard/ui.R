...
sidebar <- shinydashboardPlus::dashboardSidebar(
    minified = TRUE,
    sidebarMenu(id = "menu", 
                menuItem(" Map tools", tabName = "tab3", icon = icon("fas fa-globe-africa"), selected = T),
                menuItem(" Overview", tabName = "tab1", icon = icon("fars fa-home")),
...
body <- dashboardBody(uiOutput("modal1"),
    ...
    tabItems(
        tabItem(tabName = "tab1",
                ...
                box(solidHeader = FALSE, title = "Multi-crop Joint Priorities", background = NULL,
        ...
        tabItem(tabName = "tab3",
                ...
                box(title = tags$h4("Collecting Mission Planning Tool", tags$small("(Version 1.3.0)")),
                        status = "success", 
                        width = NULL,
                        collapsible = F,
                        enable_sidebar = TRUE,
                    ...
                    fluidRow(
                              ...
                              column(width = 6,
                                     tags$div(
                                       id = "desc_1", class= "card", style = "overflow-x: scroll;height:280px;width:100%",
                                       shiny::includeMarkdown("www/markdown/description_1.Rmd")
                                     )
                          ...
                          tags$div(class = "header-wrap",
                                   ...
                                   tags$div(class = "header-left", 
                                            shinyWidgets::dropdownButton( circle = TRUE,
                                                                          ...
                                                                          width = "600px",
                                                                          right = TRUE,
                                                                          tooltip = tooltipOptions(title = "Route summary"),
                                                                          tagList(span(tags$i(h4(tags$strong("Route summary."))), style="color:#000000"),
                                                                                  tags$hr(),
                    ...
                    fluidRow(
                        ...
                        column(9, span( 
                          actionBttn(inputId = paste0('save_session', "_bttn"),
                                    label = "",
                                    style = "simple",
                                    icon  = icon("fas fa-save"),
                                    color = "primary")%>% 
                            tagAppendAttributes(., onclick = "getElementById('save_session').click()") %>% 
                            tagAppendChild(., tags$a(id= "save_session", 
                                                     class = "shiny-download-link", 
                                                     href="", 
                                                     target="_blank",
                                                     download = NA)) %>% 
                            bs_embed_tooltip(title = "Save current session", placement = "right"),
                          actionBttn(inputId = 'get_route', 
                                                   label ='Get route',
                                                   style = "simple",
                                                   color = "primary"),
                                        downloadBttn(
        ...
        tabItem(tabName = "tab4",
                ...
                fluidRow(  
                    box(title = "Developers", status = "success",width = 3,
                                boxProfile(
                                    image = "https://avatars2.githubusercontent.com/u/29578684?s=460&v=4",

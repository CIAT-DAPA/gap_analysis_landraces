...
banana<-list.files(paste0(root,"/gap_analysis_landraces/runs/input_data/by_crop/common_bean/raster/lunatus/",region), pattern = ".tif$",full.names = TRUE);banana <- raster::stack(banana)
